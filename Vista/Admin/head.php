...
<!--168A45-->
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item">
                <a class="nav-link" href="ficha.php"><b>Fichas</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="programa.php"><b>Programas</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="fichaInstructor.php"><b>Asignar Ficha</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="instructores.php"><b>Instructores</b></a>
            </li>
        </ul>
